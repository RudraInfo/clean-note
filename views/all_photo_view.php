      ...
      <div class="row">
        <div class="col-md-10 no-paddin-xs">
          <div class="profile-nav col-md-4">
            ...
            <div id="album_btn" class="btn btn-default col-md-offset-6" style="margin-top:45px;"><a href="photo_controller/load_album">Make Album</a></div>
            ...
            <div class="panel panel-info panel-list-photos">
              <div class="panel-heading">
                ...
                <form id="frm_album" action="photo_controller/display_album" method="POST">
