...
$(document).on ("click",".Nomination",function(e) {
        ...
        alert($Nomno);
        alert($("#postdetail1").find('postdiv' + $Nomno).attr('id'));
        //$("#postdetail1").remove('post-footer' + $Nomno);
        //$("#postdetail1 .form-control").remove();        
        //$("#postdetail1 .Nomination").remove();                           
        alert('1');                       
        alert($('#postdetail1').find('img:eq(1)').attr('id'));
        $imgname=$('#postdetail1').find('img:eq(1)');
				      ...
				      <div class="pull-left meta" id="Pullleftmeta<?php echo $userdataarray[$key]['msg_id'];?>">
				          <div class="title h5" id="Titleh5<?php echo $userdataarray[$key]['msg_id'];?>">
				              ...
				              <?php
                                              ...
                                              ?>
                                              <?php /// Delete Post  ?>
                                              <span class="DeletePost" id="DeletePost<?php echo $userdataarray[$key]['msg_id'];?>" style="z-index:9999;margin-left:180px;" >✕</span>
				          ...
				          <a class="stat-item" id="comment<?php echo $count;?>"> 
				              <i class="fa fa-comments-o icon"> <?php echo $userdataarray[$key]['comment_count']; ?> </i>
                                          ...
                                          <!-- claim/nomination button   data-featherlight="#f2"  -->                                             
                                            ...
                                            { ?>
                                                <a id="Nominate<?php echo $count; ?>"  class = "Nominated" >Nominated</a>		
                                            <?php
                                            }
                                            else
                                            {?> 
                                            ...
                                            <?php 
                                              ...
                                              <br> <br>
    				  <b class="stat-item" data-featherlight="#f3" id="Boldlikeunlike<?php echo $userdataarray[$key]['msg_id']; ?>"> <?php echo $userdataarray[$key]['like_count'] ?> Other People Like this</b> 
                                  </div>       
                                      </div>
                                        ...
                                        //Test
                                            ...
                                            foreach ($commentdataarray as $key1 => $value1)
                                                ...
                                                <li class="comment" id="comment<?php echo $commentcount;?>">
                                                    ...
                                                    <div class="comment-body" id="commentbody<?php echo $commentcount?>">
                                                        <div class="comment-heading" id="commentheading<?php echo $commentcount?>">
                                                            ...
                                                            <h5 class="time"><?php  
                                                                    ...
                                                                    ?></h5>
                                                          <span class="DeleteComment" id="DeleteComment<?php echo $commentcount;?>" style="z-index:9999;margin-left:140px;" >✕</span>
                                                        </div>
                                                        <p id="commentdata<?php echo $commentcount?>"> <span id="commentvalue<?php echo $commentcount;?>"> <?php echo $commentdataarray[$key1]['comment']; ?> </span>
                                                        <input style="display: none;border-width: 0;height:30px;width:380px" class="Editcommentbox" type="text" id="Editcommentbox<?php echo $commentcount;?>" ></p>
                                                    </div>
                                                <a class="Likecomment" id="Likecomment<?php echo $commentcount;?>" style="z-index:9999;margin-left:50px;" >Like</a>
                                                <a class="Editcomment" id="Editcomment<?php echo $commentcount;?>" style="z-index:9999;margin-left:10px;" >Edit</a>
                                                </li>
                                <?php
                                    }}$commentcount=$commentcount+1;
                                    if ($commentcount>=3 and $userdataarray[$key]['comment_count']>=2)
                                    {?>
                                        <a class="Viewmorecomments" id="viewmorecomment<?php echo $commentcount;?>" style="z-index:9999;margin-left:50px;" >View More <?php echo $userdataarray[$key]['comment_count'];?> Comments </a>                                        
                                    <?php break;} 
